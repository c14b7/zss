  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
            ...
            <div className="">
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className={`ContentEditable__root relative block min-h-72 overflow-auto ${
                    readOnly 
                      ? 'min-h-[200px] cursor-default px-0 py-0' 
                      : 'h-[830px] min-h-full focus:outline-none px-8 py-4'
                  }`}
                />
              </div>
            </div>
        ...
        {!readOnly && <TableHoverActionsPlugin anchorElem={floatingAnchorElem} />}
        ...
        {!readOnly && <ComponentPickerMenuPlugin
          baseOptions={[
        ...
        {!readOnly && <FloatingLinkEditorPlugin anchorElem={floatingAnchorElem} />}
        {!readOnly && <FloatingTextFormatToolbarPlugin anchorElem={floatingAnchorElem} />}
