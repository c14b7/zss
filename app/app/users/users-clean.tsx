...
export default function UsersPage() {
    ...
    const users: User[] = [
        { id: '1', firstName: 'Anna', lastName: 'Kowalska', function: 'Przewodnicząca', group: 'Grupa 1' },
        { id: '2', firstName: 'Piotr', lastName: 'Nowak', function: 'Skarbnik', group: 'Grupa 1' },
        { id: '3', firstName: 'Maria', lastName: 'Wiśniewska', function: 'Sekretarz', group: 'Grupa 2' },
        { id: '4', firstName: 'Jan', lastName: 'Kowalczyk', group: 'Grupa 2' },
        { id: '5', firstName: 'Katarzyna', lastName: 'Lewandowska', group: 'Grupa 1' },
        { id: '6', firstName: 'Michał', lastName: 'Dąbrowski', function: 'Rzecznik', group: 'Grupa 2' },
    ];
    ...
    const handleCellValueChange = (columnId: string, userId: string, value: any) => {
        const key = `${columnId}-${userId}`;
        setCellValues(prev => ({ ...prev, [key]: value }));
    };

    const getCellValue = (columnId: string, userId: string) => {
        return cellValues[`${columnId}-${userId}`] || '';
    };

    const renderCellInput = (column: CustomColumn, userId: string) => {
        const value = getCellValue(column.id, userId);
